...
from recon.pipeline import export_analytics, load_agent_outputs, load_raw
...
def temp_settings(tmp_path, monkeypatch):
    ...
    for module in (generate, documents, load_raw, load_agent_outputs, export_analytics, server, loop, run_all, store, grade, report):
